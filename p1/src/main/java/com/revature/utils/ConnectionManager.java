...
public class ConnectionManager {
     ...
     *
     * one static method that we can call in any other class we'll need our connection
     * one static var that is set to be the connection we return
     *
    ...
    //    we are creating a private constructor because
//    we should not be able to make another instance
